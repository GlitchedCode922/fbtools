...
all: build/fbimg build/png2fbimg build/fbimg2png build/screenshotd build/paint build/libscaleimg.a build/libscaleimg.so
...
build/paint: paint.c scale_img.c
	@mkdir -p build
	$(CC) $(CFLAGS) paint.c scale_img.c -o build/paint
